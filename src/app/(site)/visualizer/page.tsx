  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden pt-16 pb-14">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_25%_10%,rgba(45,184,124,0.08),transparent_55%)]" />
        <div className="relative mx-auto max-w-[1500px] px-4 sm:px-6">
          ...
          <Reveal className="mt-6 grid gap-10 lg:grid-cols-2">
            <p data-reveal className="max-w-xl text-lg text-muted">
              Three ways to try any tile in our range —{" "}
              <em className="not-italic text-green-2">before</em> a single box leaves the
              showroom. Design a room from scratch, work on a photo of your own home, or
              let our AI re-imagine the space entirely.
            </p>
            <ul data-reveal className="grid gap-3 self-end text-sm text-body sm:grid-cols-2">
              {FEATURES.map((f) => (
